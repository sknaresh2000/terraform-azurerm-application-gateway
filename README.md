...
| <a name="input_eventhub_authorization_rule_id"></a> [eventhub\_authorization\_rule\_id](#input\_eventhub\_authorization\_rule\_id) | Event Hub Authorization Rule id for diagnostic settings | `string` | `""` | no |
...
| <a name="input_http_listeners"></a> [http\_listeners](#input\_http\_listeners) | The listener details for this app gateway | <pre>map(object({<br>    frontend_ip_configuration_name = string<br>    frontend_port_name             = string<br>    protocol                       = string<br>    host_name                      = string<br>    ssl_certificate_name           = string<br>  }))</pre> | n/a | yes |
...
| <a name="input_storage_account_id"></a> [storage\_account\_id](#input\_storage\_account\_id) | Storage account id for diagnostic settings | `string` | `""` | no |
